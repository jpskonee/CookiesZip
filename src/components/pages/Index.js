      ...
      <Container maxWidth="lg">
        <div className="get-ready-div">
          <HeaderText
            ...
            align="center"
          />
          <div className="get-ready-desp">NOVEMBER 3</div>
          ...
          <div className="get-ready-desp-2">
            <DespText text="Owning one of the “freshly baked” batch of cookies will bring you lots of fortune, including future airdrops and chances to win other NFTs. Cookie holders will be able to crack their fortune cookie open and earn more rewards. Hold those cookies tight and you will be blessed with good fortune." />
          </div>
        </div>
      </Container>
      <Container maxWidth="lg">
